...
const Contact = () => {
	...
	return (
		<main
			id='contact'
			className='xl:mt-12 overflow-hidden intersector relative z-0'
		>
			<section className='flex lg:flex-row flex-col gap-10'>
				<div className='flex-[0.75] bg-[rgba(0,0,0,0.7)] p-8 rounded-md border border-slate-900 w-full max-w-[500px] mx-auto sm:mx-0'>
